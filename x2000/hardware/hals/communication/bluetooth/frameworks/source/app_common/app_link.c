...
/*******************************************************************************
 **
 ** Function        app_link_transport_type_desc
 **
 ** Description     Get Link Type Description
 **
 ** Returns         Description
 **
 *******************************************************************************/
char *app_link_transport_type_desc(tBSA_TRANSPORT link_type)
{
    switch(link_type)
    {
    case BSA_TRANSPORT_BR_EDR:
        return "BR/EDR";
    case BSA_TRANSPORT_LE:
        return "BLE";
    }
    return "Unknown";
}
