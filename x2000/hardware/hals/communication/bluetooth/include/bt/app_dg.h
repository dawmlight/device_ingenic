...
/*******************************************************************************
 **
 ** Function        app_dg_send
 **
 ** Description     send data
 **
 ** Parameters      connection spp connection,the data value that send to client
 **
...
/*******************************************************************************
 **
 ** Function        app_dg_register_write_cback
 **
 ** Description     Set call back of receive write data
 **
 ** Parameters      receiveWriteDataCback call back function
 **
 ** Returns         status: 0 if success / -1 otherwise
 **
 *******************************************************************************/
int app_dg_register_write_cback(void *user, void (*receiveSppDataCback)(void *user, int conn_id, char * data, int size));
#endif
