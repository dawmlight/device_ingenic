...
#define atrace_init(tag, name, value)         ((void)0)
#define atrace_get_enabled_tags()             ((void)0)
#define atrace_is_tag_enabled(tag)            ((void)0)
#define atrace_begin(tag, name)               ((void)0)
#define atrace_end(tag)                       ((void)0)
#define atrace_async_begin(tag, name, cookie) ((void)0)
#define atrace_async_end(tag, name, cookie)   ((void)0)
void atrace_update_tags() {return;}
