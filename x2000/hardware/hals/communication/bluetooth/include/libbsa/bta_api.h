...
/* Remote Name */
typedef tBTM_REMOTE_DEV_NAME tBTA_DM_REMNAME;
...
/*******************************************************************************
**
** Function         BTA_DmSetBleDeviceName
**
** Description      This function sets the Bluetooth name of the local ble device.
**                  
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmSetBleDeviceName(char *p_name);
