...
#define BOOTARGS_COMMON "console=ttyS3,115200 mem=128M@0x0 loglevel=7 init=/bin/init"
	...
	#define CONFIG_BOOTARGS BOOTARGS_COMMON " rootfstype=ext4 root=/dev/mmcblk0p8 rootwait rw"
...
#define CONFIG_BOOTDELAY 0
	...
	"ubifsload 0x80f00000 vmlinux.ub; bootm 0x80f00000"
		...
		#define CONFIG_SPL_BOOTARGS BOOTARGS_COMMON " rootfstype=ext4 root=/dev/mmcblk0p8 rootwait rw"
...
#define CONFIG_GPT_TABLE_PATH	"$(SRCTREE)/board/$(BOARDDIR)"
#else
