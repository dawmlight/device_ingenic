...
#define DDRP_INNOPHY_PLL_LOCK		(DDR_PHY_OFFSET + 0x0c8)
#define DDRP_INNOPHY_CALIB_DONE		(DDR_PHY_OFFSET + 0x0cc)
...
#define DDRP_INNOPHY_CALIB_DELAY_AL	(DDR_PHY_OFFSET + 0x158)
#define DDRP_INNOPHY_CALIB_DELAY_AH	(DDR_PHY_OFFSET + 0x198)
#define DDRP_INNOPHY_CALIB_DELAY_BL	(DDR_PHY_OFFSET + 0x218)
#define DDRP_INNOPHY_CALIB_DELAY_BH	(DDR_PHY_OFFSET + 0x258)
#endif

#if 0
#define DDRP_INNOPHY_RXDLL_DELAY_AL		(DDR_PHY_OFFSET + (0x15 << 2))
#define DDRP_INNOPHY_RXDLL_DELAY_AH		(DDR_PHY_OFFSET + (0x16 << 2))
#define DDRP_INNOPHY_FPGA_RXDLL_DELAY		(DDR_PHY_OFFSET + (0x2a << 2))
#else
