...
enum opt_code
{
  ...
  OPT_mfusion = 1195,                        /* -mfusion */
  OPT_mglibc = 1196,                         /* -mglibc */
  OPT_mgp32 = 1197,                          /* -mgp32 */
  OPT_mgp64 = 1198,                          /* -mgp64 */
  OPT_mgpopt = 1199,                         /* -mgpopt */
  OPT_mhard_float = 1200,                    /* -mhard-float */
  OPT_mimadd = 1201,                         /* -mimadd */
  OPT_minterlink_compressed = 1202,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1203,              /* -minterlink-mips16 */
  OPT_mips = 1204,                           /* -mips */
  OPT_mips16 = 1205,                         /* -mips16 */
  OPT_mips3d = 1206,                         /* -mips3d */
  OPT_mllsc = 1207,                          /* -mllsc */
  OPT_mload_store_pairs = 1208,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1209,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1210,                    /* -mlong-calls */
  OPT_mlong32 = 1211,                        /* -mlong32 */
  OPT_mlong64 = 1212,                        /* -mlong64 */
  OPT_mlra = 1213,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1214,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1215,                           /* -mmad */
  OPT_mmadd4 = 1216,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1217,             /* -mmcount-ra-address */
  OPT_mmcu = 1218,                           /* -mmcu */
  OPT_mmemcpy = 1219,                        /* -mmemcpy */
  OPT_mmicromips = 1220,                     /* -mmicromips */
  OPT_mmsa = 1221,                           /* -mmsa */
  OPT_mmt = 1222,                            /* -mmt */
  OPT_mmusl = 1223,                          /* -mmusl */
  OPT_mmxu = 1224,                           /* -mmxu */
  OPT_mmxu2 = 1225,                          /* -mmxu2 */
  OPT_mnan_ = 1226,                          /* -mnan= */
  OPT_mno_float = 1227,                      /* -mno-float */
  OPT_mno_flush_func = 1228,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1229,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1230,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1231,                     /* -mno-mips3d */
  OPT_modd_spreg = 1232,                     /* -modd-spreg */
  OPT_mpaired_single = 1233,                 /* -mpaired-single */
  OPT_mplt = 1234,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1235,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1236,               /* -mrelax-pic-calls */
  OPT_mshared = 1237,                        /* -mshared */
  OPT_msingle_float = 1238,                  /* -msingle-float */
  OPT_mslsa = 1239,                          /* -mslsa */
  OPT_msmartmips = 1240,                     /* -msmartmips */
  OPT_msoft_float = 1241,                    /* -msoft-float */
  OPT_msplit_addresses = 1242,               /* -msplit-addresses */
  OPT_msym32 = 1243,                         /* -msym32 */
  OPT_msynci = 1244,                         /* -msynci */
  OPT_mtune_ = 1245,                         /* -mtune= */
  OPT_muclibc = 1246,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1247,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1248,                          /* -mvirt */
  OPT_mvr4130_align = 1249,                  /* -mvr4130-align */
  OPT_mxgot = 1250,                          /* -mxgot */
  OPT_mxpa = 1251,                           /* -mxpa */
  OPT_n = 1252,                              /* -n */
  OPT_no_canonical_prefixes = 1253,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1254,              /* -no-integrated-cpp */
  OPT_no_pie = 1255,                         /* -no-pie */
  OPT_noasmopt = 1256,                       /* -noasmopt */
  OPT_nocpp = 1257,                          /* -nocpp */
  OPT_nodefaultlibs = 1258,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1259,                   /* -nostartfiles */
  OPT_nostdinc = 1260,                       /* -nostdinc */
  OPT_nostdinc__ = 1261,                     /* -nostdinc++ */
  OPT_nostdlib = 1262,                       /* -nostdlib */
  OPT_o = 1263,                              /* -o */
  OPT_p = 1264,                              /* -p */
  OPT_pass_exit_codes = 1265,                /* -pass-exit-codes */
  /* OPT_pedantic = 1266, */                 /* -pedantic */
  OPT_pedantic_errors = 1267,                /* -pedantic-errors */
  OPT_pg = 1268,                             /* -pg */
  OPT_pie = 1269,                            /* -pie */
  OPT_pipe = 1270,                           /* -pipe */
  OPT_posix = 1271,                          /* -posix */
  OPT_print_file_name_ = 1272,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1273,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1274,          /* -print-multi-directory */
  OPT_print_multi_lib = 1275,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1276,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1277,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1278,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1279,               /* -print-prog-name= */
  OPT_print_search_dirs = 1280,              /* -print-search-dirs */
  OPT_print_sysroot = 1281,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1282,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1283,                        /* -profile */
  OPT_pthread = 1284,                        /* -pthread */
  OPT_quiet = 1285,                          /* -quiet */
  OPT_r = 1286,                              /* -r */
  OPT_rdynamic = 1287,                       /* -rdynamic */
  OPT_remap = 1288,                          /* -remap */
  OPT_s = 1289,                              /* -s */
  OPT_save_temps = 1290,                     /* -save-temps */
  OPT_save_temps_ = 1291,                    /* -save-temps= */
  OPT_shared = 1292,                         /* -shared */
  OPT_shared_libgcc = 1293,                  /* -shared-libgcc */
  /* OPT_specs = 1294, */                    /* -specs */
  OPT_specs_ = 1295,                         /* -specs= */
  OPT_static = 1296,                         /* -static */
  OPT_static_libasan = 1297,                 /* -static-libasan */
  OPT_static_libgcc = 1298,                  /* -static-libgcc */
  OPT_static_libgfortran = 1299,             /* -static-libgfortran */
  OPT_static_libgo = 1300,                   /* -static-libgo */
  OPT_static_liblsan = 1301,                 /* -static-liblsan */
  OPT_static_libmpx = 1302,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1303,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1304,               /* -static-libstdc++ */
  OPT_static_libtsan = 1305,                 /* -static-libtsan */
  OPT_static_libubsan = 1306,                /* -static-libubsan */
  /* OPT_std_c__03 = 1307, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1308, */                /* -std=c++0x */
  OPT_std_c__11 = 1309,                      /* -std=c++11 */
  OPT_std_c__14 = 1310,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1311, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1312, */                /* -std=c++1y */
  OPT_std_c__1z = 1313,                      /* -std=c++1z */
  OPT_std_c__98 = 1314,                      /* -std=c++98 */
  OPT_std_c11 = 1315,                        /* -std=c11 */
  /* OPT_std_c1x = 1316, */                  /* -std=c1x */
  /* OPT_std_c89 = 1317, */                  /* -std=c89 */
  OPT_std_c90 = 1318,                        /* -std=c90 */
  OPT_std_c99 = 1319,                        /* -std=c99 */
  /* OPT_std_c9x = 1320, */                  /* -std=c9x */
  OPT_std_f2003 = 1321,                      /* -std=f2003 */
  OPT_std_f2008 = 1322,                      /* -std=f2008 */
  OPT_std_f2008ts = 1323,                    /* -std=f2008ts */
  OPT_std_f95 = 1324,                        /* -std=f95 */
  OPT_std_gnu = 1325,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1326, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1327, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1328,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1329,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1330, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1331, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1332,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1333,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1334,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1335, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1336, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1337,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1338,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1339, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1340, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1341,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1342, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1343, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1344, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1345,                     /* -std=legacy */
  OPT_symbolic = 1346,                       /* -symbolic */
  OPT_t = 1347,                              /* -t */
  OPT_time = 1348,                           /* -time */
  OPT_time_ = 1349,                          /* -time= */
  OPT_tno_android_cc = 1350,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1351,                 /* -tno-android-ld */
  OPT_traditional = 1352,                    /* -traditional */
  OPT_traditional_cpp = 1353,                /* -traditional-cpp */
  OPT_trigraphs = 1354,                      /* -trigraphs */
  OPT_u = 1355,                              /* -u */
  OPT_undef = 1356,                          /* -undef */
  OPT_v = 1357,                              /* -v */
  OPT_version = 1358,                        /* -version */
  OPT_w = 1359,                              /* -w */
  OPT_wrapper = 1360,                        /* -wrapper */
  OPT_x = 1361,                              /* -x */
  OPT_z = 1362,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
