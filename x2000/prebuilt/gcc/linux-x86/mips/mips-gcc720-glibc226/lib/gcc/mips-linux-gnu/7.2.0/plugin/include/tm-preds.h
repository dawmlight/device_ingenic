/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home1/tyliu/work/release-4.1.1-gcc720/release-4.1.1-gcc720/src/gcc-7-2017.11/gcc/config/mips/mips.md'.  */
...
extern int const_msa_branch_operand (rtx, machine_mode);
...
extern int const_imm5_operand (rtx, machine_mode);
...
extern int aq10_4_operand (rtx, machine_mode);
...
extern int const_vector_same_uimm8_operand (rtx, machine_mode);
...
extern int const_vector_same_simm15_operand (rtx, machine_mode);
extern int const_imm15_operand (rtx, machine_mode);
