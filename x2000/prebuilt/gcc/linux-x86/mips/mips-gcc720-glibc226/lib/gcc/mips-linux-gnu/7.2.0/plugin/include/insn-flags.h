...
#define HAVE_msa_vshf_d_f (ISA_HAS_MSA)
#define HAVE_msa_vshf_w_f (ISA_HAS_MSA)
#define HAVE_msa_vshf_d (ISA_HAS_MSA)
#define HAVE_msa_vshf_w (ISA_HAS_MSA)
#define HAVE_msa_vshf_h (ISA_HAS_MSA)
#define HAVE_msa_vshf_b (ISA_HAS_MSA)
...
#define HAVE_movv2df (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movv4sf (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movv2di (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movv4si (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movv8hi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movv16qi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv2df (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv4sf (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv2di (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv4si (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv8hi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_movmisalignv16qi (ISA_HAS_MSA || ISA_HAS_MXU2)
...
extern rtx        gen_msa_vshf_d_f                    (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_vshf_w_f                    (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_vshf_d                      (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_vshf_w                      (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_vshf_h                      (rtx, rtx, rtx, rtx);
extern rtx        gen_msa_vshf_b                      (rtx, rtx, rtx, rtx);
